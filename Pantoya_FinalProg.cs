...
public class Program
{
    ...
    void addEntree()
    {
        ...
        Console.WriteLine("Add Entrees to Order\n********************\n");
        ...
        hold.entree.Add(Fentree[ind]); fOrder.Add(Fentree[ind]); Console.Clear(); createOrder();
    }
    ...
    void addSide()
    {
        ...
        string sel = Console.ReadLine();
        int ind = Int32.Parse(sel); ind--;
        hold.side.Add(Fside[ind]); fOrder.Add(Fside[ind]); Console.Clear(); createOrder();
    }
    ...
    void addDrink()
    {
        ...
        string sel = Console.ReadLine();
        int ind = Int32.Parse(sel); ind--;
        hold.drink.Add(Fdrink[ind]); fOrder.Add(Fdrink[ind]); Console.Clear(); createOrder();
    }

    void completeOrder()
    {
        Console.WriteLine("Are you sure you want to complete the order? y/n");
        string input = Console.ReadLine();
        if (input == "y")
        {
            curOrder.Add(hold); hold = null; Console.Clear(); homeSys();
        }
        else { Console.Clear(); createOrder(); }

    }

    void exitOrder()
    {
        Console.WriteLine("Are you sure you want to exit the order? The order will not be saved. y/n");
        string input = Console.ReadLine();
        if (input == "y")
        {
            hold = null; Console.Clear(); homeSys();
        }
        else { Console.Clear(); createOrder(); }
    }
    ...
    void vOrders()
    {
        ...
        if (curOrder.Count == 0)
        {
            ...
            if (ex == "Exit") { Console.Clear(); homeSys(); }
        }
        ...
        if (ord == "1")
        {
            ...
            if (completed == 0) { Console.Clear(); vOrders(); }
        }
        else if (ord == "2")
        {
            Console.WriteLine("Which order would you like to cancel?");
            string com = Console.ReadLine();
            Console.WriteLine($"Are you sure you want to cancel order {com}? y/n");
    ...
    void orderHistory()
    {
        ...
        Console.WriteLine("\nUser Input: ");
        string ord = Console.ReadLine();
        if (ord == "1") { Console.Clear(); homeSys(); }
        else { Console.Clear(); orderHistory(); }
    }
